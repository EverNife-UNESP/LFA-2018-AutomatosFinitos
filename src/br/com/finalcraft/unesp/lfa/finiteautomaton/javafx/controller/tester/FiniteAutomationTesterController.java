package br.com.finalcraft.unesp.lfa.finiteautomaton.javafx.controller.tester;

import br.com.finalcraft.unesp.lfa.finiteautomaton.application.FiniteAutomationApplication;
import br.com.finalcraft.unesp.lfa.finiteautomaton.application.validator.HistoryLog;
...
public class FiniteAutomationTesterController {
    ...
    private static void onMoveNiddle(){
        ...
        FiniteAutomationApplication.getGraph().getAllVertex().forEach(anVertex -> {
        ...
        try{
            Vertex vertex = FiniteAutomationApplication.getGraph().getVertex(stageID);
